...
<p>Not all of it is needed on day one. The sensible order is the one that stops the most expensive daily problem first &mdash; usually stock accuracy or works orders &mdash; and phases the rest as each piece goes into real use.</p>`,
      figure: { img: 'istock-2189585598-electronics-factory-engineers-laptop.jpg', alt: 'Engineers checking stock and works orders on a laptop in a manufacturing facility', w: 612, h: 344, cap: 'The production layer is what turns an order into a costed, traceable job rather than a promise and a spreadsheet.' } },
...
// ------------------------------------------------------------------ 2. ERP for small business (UK)
{
  ...
  lead: { img: 'small-business-owner-laptop-sidewalk-cafe.jpg', alt: 'Small business owner reviewing their operations on a laptop', w: 678, h: 452 },
  takeaways: [
...
<p>Note what is not on that list: doing nothing while growing. That is the option that costs the most and never appears on an invoice.</p>`,
      figure: { img: 'team-flatlay-reviewing-business-report-charts.jpg', alt: 'Small business team reviewing operational reports together', w: 739, h: 415, cap: 'The decision is rarely about features. It is about whether the same information is being entered twice.' } },
...
// ------------------------------------------------------------------ 3. ERP implementation
{
  ...
  lead: { img: 'whiteboard-process-mapping-two-colleagues.jpg', alt: 'Two colleagues mapping a business process on a whiteboard during ERP discovery', w: 2400, h: 1601 },
  takeaways: [
...
// ------------------------------------------------------------------ 4. MRP vs ERP vs WMS
{
  ...
  lead: { img: 'istock-1489414046-woman-engineer-laptop-ops-room.jpg', alt: 'Operations engineer reviewing planning and warehouse data on a laptop', w: 612, h: 323 },
  takeaways: [
...
<p>For UK businesses it is also where the compliance layer sits: MTD-ready digital records from order to invoice, stock and WIP valuation your accountant can use at year end, and duty and origin data captured on the purchase if you import. See <a href="/uk/erp/">custom ERP for UK businesses</a> for how that gets built in practice.</p>`,
      figure: { img: 'istock-2231952003-presenting-dashboard-wood-meeting-room.jpg', alt: 'Team reviewing operational data on a shared dashboard', w: 612, h: 408, cap: 'ERP earns its keep when the whole business argues from one number instead of five spreadsheets.' } },
