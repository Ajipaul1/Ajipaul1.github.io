...
// ------------------------------------------------------------------ 30. Business website
{
  ...
  takeaways: [
    ...
    'Three ways to build: do it yourself on a builder (US$20&ndash;$100/month, your time), hire a freelancer (US$3,000&ndash;$10,000), or hire an agency or build-and-run partner (agencies US$15,000&ndash;$75,000+; TechAuditPros on one agreed monthly fee, all-in). Pick by how much the site has to <em>win</em>, not by budget alone.',
...
<tr><th>Build-and-run partner (flat monthly)</th><td>The site has to win customers and keep improving; you want one accountable team</td><td>TechAuditPros on one agreed monthly fee, all-in</td><td>Confirm what "all-in" includes and that you own the code (with us, everything)</td></tr>
</table></div>
...
<p>If you would rather hand the whole sequence to one team &mdash; planning, content structure, design, build, SEO foundation and the ongoing improvement &mdash; that is what our <a href="/us/website-development/">US website development service</a> and <a href="/ca/website-development/">Canadian service</a> do for a flat monthly rate, with the first live version in 4&ndash;8 weeks.</p>` },
  ...
  faqs: [
    ...
    { q: 'How much does it cost to get a business website made?', a: 'DIY builders run US$20&ndash;$100 a month plus your time; freelancers US$3,000&ndash;$10,000 upfront; agencies US$15,000&ndash;$75,000+ plus maintenance; TechAuditPros builds and runs business websites one agreed monthly fee.' },
...
<ol start="11">
<li><strong>Who exactly will do the work, and who will I talk to?</strong> An accountable engineering team beats an account manager relaying messages.</li>
...
<tr><th>Typical US cost</th><td>US$3,000&ndash;$10,000 upfront</td><td>US$15,000&ndash;$75,000+ upfront, plus US$500&ndash;$2,000+/month</td><td>TechAuditPros on one agreed monthly fee, all-in</td></tr>
...
<p>In the interest of practicing what we recommend: our sites are custom-built on Next.js and React to 90+ mobile Core Web Vitals; the technical SEO foundation is part of every build because the same team runs SEO; you own the code, content, domain and hosting; there is no minimum term; design, build, hosting setup, maintenance and ongoing changes are one one agreed monthly fee for <a href="/us/website-development/">US businesses</a> (one agreed monthly fee for <a href="/ca/website-development/">Canadian businesses</a>); you talk to the engineer doing the work, on a staging site you can click through; and we will tell you what not to build. The honest weakness: we are in Kochi, India, 9.5 hours ahead of New York, so if you need someone in your office, we are not the right fit &mdash; ask us anything else on a strategy call.</p>` },
  ...
  faqs: [
    ...
    { q: 'Is it safe to hire an offshore web development company?', a: 'Yes, with the same checks as any provider plus two: confirm the communication model (overlap hours, response times, a named point of contact) and that code, accounts and data are in your name from day one. Time zones can be an advantage &mdash; work sent at the end of your day is done by morning.' },
  ],
  cta: WEB_CTA,
},
