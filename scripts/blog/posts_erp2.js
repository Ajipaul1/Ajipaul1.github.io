...
<p>For how the people module fits with the rest of the system, see <a href="/blog/erp-system-examples.html">ERP system examples by business type</a>.</p>` },
  ...
  faqs: [
    ...
    { q: 'How much does HR software cost for a small business?', a: 'Standalone HR tools commonly run from a few dollars to around US$20 per employee per month, with payroll and benefits administration priced separately. Inside a TechAuditPros custom ERP, the people module is part of the flat US$1,800 per month rather than a per-employee fee.' },
  ],
  cta: ERP_CTA,
},
