...
const FAQS = [
  ...
  { q: 'Are you certified?', a: 'Yes &mdash; Google Analytics (GA4), Google Ads Search, Semrush SEO Toolkit and a digital marketing certification, all held by the founder and shown on this page as issued. They prove training, not results. What proves results is work you can open: the Viraat Marine shipyard ERP and the Telgo Power Projects website, both in Kerala.' },
];
...
const ACT_ONE = [
  ...
  '      <ul class="ker-facts">',
  '        <li><b>45 days</b> shipyard ERP, start to live</li><li><b>19</b> role desks live</li><li><b>2</b> client systems live</li><li><b>GST</b> registered in Kerala</li>',
  '      </ul>',
