...
s = L.setHead(s, {
  ...
  desc: 'TechAuditPros is an AI-native engineering team for UK businesses: custom ERP software, high-performance website development and SEO/AEO/GEO from one dedicated team &mdash; one agreed monthly fee, UK GDPR compliant, data in AWS London, no long-term contract.',
  url: URL,
...
const hero = `
            ...
            <p class="hero-subtitle">TechAuditPros is a dedicated AI-native technical team running custom ERP builds, website development and SEO with AI-search optimisation for UK businesses and agencies &mdash; from London and Manchester to Leeds, Bristol and the Thames Valley &mdash; for one agreed monthly fee, with your data in AWS London.</p>
        ...
        <div class="compare-grid">
            ...
            <div class="compare-card positive">
                ...
                <ul>
                    ...
                    <li>One agreed monthly fee &mdash; month to month, in pounds, no UK VAT added</li>
...
body += L.statRow('how-it-works', 'How the UK &harr; India Model Works', 'Our afternoon is your morning &mdash; and our evening is your build window.', 'Kochi runs 4.5 hours ahead of London in summer (BST) and 5.5 hours ahead in winter (GMT). Here is what that means in practice.', [
  ['Every UK morning', 'A live overlap window for calls, Slack and Teams with your team'],
...
body += L.promise({
  ...
  p: 'Behind every UK engagement is a small, senior team &mdash; not a rotating cast of account managers. You know the team by name, they know your business by heart, and the whole team stands behind every launch. That is what one accountable partner for ERP, web and SEO feels like week to week.',
...
L.must(s, 'one agreed monthly fee'); L.must(s, 'reverse charge');
...
L.must(s, '<span class="region-rate-amount">', 5);            // five market cards, prices now scoped on a call
