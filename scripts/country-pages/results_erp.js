...
const CSS = `
  ...
  .vm-spark{ fill:var(--orange); opacity:0; } html:not(.vm-on) .vm-spark{ display:none; }   /* decorative weld sparks exist only when the animation can run; JS off = no hidden boxes */
  ...
  .vm-tl h3{ font-size:1rem; margin:6px 0 6px; color:#fff; }
