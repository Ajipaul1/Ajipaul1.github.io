...
s = L.setHead(s, {
  ...
  desc: 'Custom website design and development for US businesses &mdash; Next.js and React builds engineered for 90+ Core Web Vitals, mobile-first, SEO-ready from day one. Flat US$1,800/month including updates; you own the code.',
  url: URL,
  hreflang: [{ lang: 'en-us', href: URL }, { lang: 'en-ca', href: 'https://techauditpros.com/ca/website-development/' }],
});

const faqs = [
  { q: 'How much does a business website cost in the US?', a: 'US freelancers typically charge US$3,000&ndash;$10,000 upfront for a template-based site, and agencies US$15,000&ndash;$75,000 or more for a custom build, with maintenance billed separately. TechAuditPros designs, builds and keeps improving your site for a flat US$1,800 per month &mdash; design, development, updates, speed work and the technical SEO foundation included, no separate maintenance invoice.' },
  ...
  { q: 'Is ongoing maintenance included?', a: 'Yes. Updates, new pages, security patches, speed monitoring and small improvements are part of the flat monthly rate, handled by the same engineer who built the site &mdash; not a separate maintenance plan or a support queue.' },
...
s = L.setHero(s, {
  ...
  sub: 'TechAuditPros designs and builds custom, mobile-first websites for US businesses on Next.js and React &mdash; 90+ Core Web Vitals, SEO-ready from the first sprint, and kept current every month by the engineer who built it. Flat US$1,800/month including updates. You own the code.',
  ...
  trust: [['250+', 'Projects delivered'], ['US$1,800', 'Flat rate/mo, updates included'], ['4&ndash;8 wks', 'To first live version'], ['4.9/5', 'Client rating']],
});

let body = '';
body += L.answer('<strong>Website development services</strong> cover everything it takes to design, build and keep a business website working: UX and visual design, front-end and back-end code, integrations, hosting, speed and the technical SEO foundation. TechAuditPros builds custom sites for US businesses on <strong>Next.js and React</strong> &mdash; mobile-first, 90+ Core Web Vitals, structured for Google and AI search &mdash; and keeps improving them for a <strong>flat US$1,800/month</strong>, instead of a US$15,000&ndash;$75,000 upfront agency project plus a maintenance retainer.');
...
body += L.compareTable('web-compare', 'Builder vs. Template vs. Custom', 'Three ways to get a business website &mdash; compared honestly.', 'A DIY builder is the right answer for some businesses. Here is how to tell which column you are in.', ['DIY website builder', 'Template / theme site', 'Custom build (TechAuditPros)'], 2, [
  ...
  ['Cost pattern', 'US$20&ndash;$100/month, your time as the labor', 'US$3,000&ndash;$10,000 upfront plus maintenance', 'Flat US$1,800/month including design, build and updates'],
...
body += L.whySection('Why TechAuditPros', 'Fast, secure, accessible &mdash; and yours.', [['\u{1F512}', 'NDA Protected'], ['\u{1F4BB}', 'You Own Code &amp; Content'], ['⚡', '90+ Core Web Vitals Target'], ['♿', 'WCAG 2.1 AA Practices']], 'Built on', ['Next.js', 'React', 'Node.js', 'Headless CMS', 'Shopify (when it fits)', 'Vercel / AWS (US regions)']);
