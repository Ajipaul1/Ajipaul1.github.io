...
const CSS = `
  ...
  /* ================= the phone cut =================
     Same idea as the film on /uk/: rails give one frame the screen, stacked variants keep their
     pictures big rather than shrinking to thumbnails, and captions over pictures get a heavier
     scrim at 390px. */
  @media (max-width:700px){
    .uks-section{ padding-bottom:8px; }
    .uksA .plate{ margin-bottom:24px; }
    .uksA .shot{ aspect-ratio:4/3; border-radius:12px; }
    .uksA .words{ margin-top:14px; }
    .uksA .words .uks-cap{ font-size:1.28rem; }

    .uksB .rail{ gap:6px; padding:2px 0 16px; }
    .uksB .frame{ flex:0 0 82vw; }
    .uksB .shot{ aspect-ratio:4/5; }
    .uksB .words .uks-cap{ font-size:1.04rem; }

    .uksC .band{ margin-bottom:18px; }
    .uksC .words{ padding:20px 20px 22px; }
    .uksC .uks-cap{ font-size:1.3rem; max-width:none; }

    .uksD{ gap:14px; }
    .uksD .shot{ aspect-ratio:4/3; }
    .uksD .words{ padding:15px 17px 18px; }
    .uksD .words .uks-cap{ font-size:1.08rem; }

    .uksE .lead .shot{ aspect-ratio:5/4; }
    .uksE .lead .words{ padding:20px 20px 22px; }
    .uksE .lead .uks-cap{ font-size:1.4rem; }
    .uksE .cards{ gap:14px; }
    .uksE .card .shot{ aspect-ratio:16/10; }

    .uksF{ gap:28px; }
    .uksF .col > h4{ margin-bottom:12px; }
    .uksF .tile .shot{ aspect-ratio:16/10; }
    .uksF .tile .words{ padding:14px 16px 16px; }
  }
