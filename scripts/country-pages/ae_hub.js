...
const ACT1 = [
  ...
  '    <div><h3>What you do not get</h3><ul class="aea-list"><li>An office in Dubai or Abu Dhabi, or a meeting room to walk into.</li><li>A UAE phone number. Until we have one, this page uses the WhatsApp we have and says so.</li><li>A wall of GCC logos. Our live work so far is in India: a shipyard ERP and a power contractor&rsquo;s website, both in Kerala, both open for you to check.</li></ul></div>',
...
const ACT3 = [
  ...
  '      <article class="cr" style="--d:2"><figure>' + img(STOCK.erp, 'Construction cranes and buildings at sunset', '(max-width:860px) 100vw, 30vw') + '</figure><span class="k">03 &middot; Systems</span><h3>Custom ERP for the UAE</h3><p>Stock, orders, purchasing, projects and payroll in one system of record with VAT, Corporate Tax, PINT-AE e-invoicing, WPS and EOSB built in &mdash; for trading, construction, automotive and distribution businesses that have outgrown Tally, Zoho or a spreadsheet.</p><a class="aea-link" href="' + (fs.existsSync(path.join(L.REPO, 'ae', 'erp', 'index.html')) ? '/ae/erp/' : '/us/erp/') + '">How the systems run &rarr;</a></article>',
  '    </div>',
  '  </div>',
  '</section>',
].join('\n');
